...
st.subheader(
    ...
    "по группам ожидаемому сплиту эксперимента. Если различие слишком велико и "
    "маловероятно как результат случайности, это может указывать на проблемы в "
    "эксперименте: ошибки рандомизации, баги трекинга, перекос трафика или потерю части данных."
)
