...
configure_page(title="Статкритерий для ARPU", icon="💰")
render_tool_header(
    "Статкритерий для ARPU",
...
st.caption(
    ...
    "должно быть рассчитано на уровне регистраций, включая нулевую выручку для тех, кто не купил."
)
